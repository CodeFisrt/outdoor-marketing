...
//           localStorage.setItem('role', res2.user.role);
//           localStorage.setItem('userName', res2.user.userName);
//           localStorage.setItem('userEmail', res2.user.userEmail);

//           this.toastr.success(`Login Successful ✅ Welcome "${res2.user.userName}"`);

//           // ✅ role-based redirect (you can change routes later)
//           if (res2.user.role === 'admin') this.router.navigateByUrl('/dashboard');
